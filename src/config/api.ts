...
export const API_CONFIG = {
  // Replace with your Google AI API key.  Ensure this key is properly secured in a production environment.
  GOOGLE_AI_API_KEY: "AIzaSyCablAQKjpaPDUG-hJG0eerBXaeR3bgUoQ",
  
  // API endpoint for Gemini Pro.  Consider making this configurable via environment variables.
  GOOGLE_AI_ENDPOINT: "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent",
  
  // System prompt for Aura - Sustainability Copilot.  This prompt defines the AI's behavior.
...
// Utility function to check if the API key is configured.  Returns true if the key is not the default and has a valid length.
export const isApiConfigured = () => {
  // This check is relaxed to allow proceeding with the placeholder key for demonstration purposes.
  // For production, a more robust check against the actual placeholder value is recommended.
